...
import VehicleTrimLevelForm from './forms/VehicleTrimLevelForm';

const ManageVehicleTrimLevel = () => {
    ...
    return (
      <Layout className='h-full'>
        <PageHeader title={"Manage Vehicle Trim Level"} icon={<FaCar />} handleAdd={handleAdd} handleUpdate={handleUpdate} handleDelete={handleDelete} />
        ...
        <VehicleTrimLevelForm isModalOpen={isModalOpen} closeModal={closeModal} fieldValue={fieldValue} />
      </Layout>
    )
}
...
export default ManageVehicleTrimLevel